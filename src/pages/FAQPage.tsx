...
export default function FAQPage() {
  ...
  const faqData = {
    ...
    callisto: [
      ...
      {
        id: 10,
        question: "How extensive is the story?",
        answer: "The main story offers 40+ hours of content, with additional side quests, lore content and post-game material for 100+ hours of gameplay."
      },
      {
        id: 16,
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-void-hero void-particles py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-5xl mb-6 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
            Frequently Asked Questions
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Here you will find answers to the most frequently asked questions about Devomon: Callisto, Devomon: Voidborn and the entire universe.
          </p>
        </div>
      </section>

const About = () => {
  return (
    <>
      <section className="relative pt-[100px] pb-[80px] xs:pb-[100px] lg:py-[100px] xl:pb-[50px] play-earn about_bg_img bg-aboutBgImg bg-no-repeat sm:-translate-y-[0px] lg:-translate-y-[0px] -translate-y-[0px] z-10 bg-cover">
        <div className="container">
          <div className="sm:mt-12 pb-16">

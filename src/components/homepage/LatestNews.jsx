    ...
    <>
      <div className="bg-latestNews_bg_img bg-no-repeat bg-cover pt-[120px] pb-[205px]">
        <div className="container">
          ...
          <div className="flex flex-col xl:flex-row items-center rounded-[12px] bg-[rgba(255, 255, 255, 0.08)] xl:h-[460px] bg-latestNews_bg_color">
            ...
            <div className="mx-auto w-full lg:w-3/4 xl:w-full md:px-4 mt-10 xl:mt-0 h-[527px] xl:h-full pt-[10px]">
              ...
              <div className="xl:text-end text-center mt-5 lg:mt-8 xl:mt-0 pt-3">
                <button
                  type="submit"

  ...
  return (
    <section className="px-3 relative pb-10 sm:pb-20 lg:pb-24 pt-24 sm:pt-32 bg-black overflow-x-hidden">
      <div className="mx-auto xl:w-[952px] text-white">
        ...
        <p className="font-normal font-poppins">
          This Privacy Policy clarifies how Saguni Tech LLC, operator of Devomon
          (“we”, “us”, “our”, etc.), collects, uses, and shares your personal
          ...
          services (collectively “Services”), or otherwise interact with us. We
          are the data controller of your personal data under the EU General
          Data Protection Regulation and other local data protection laws. We
          may change this Privacy Policy from time to time and will notify you
          accordingly. .
        </p>
        ...
        <ul className="font-normal font-poppins list-disc  pl-8 space-y-2">
          ...
          <li>
            <p>
              <strong>Information collected from third parties:</strong> We may
              also gather data from other sources and combine it with the
          ...
          <li>
            <p>
              ...
              limited to, device information (such as model, operating system),
              usage data (such as gameplay activities, in-app purchases), and
              personal data required for creating a user account.
            </p>
          </li>
        </ul>
        ...
        <ul className="font-normal font-poppins list-disc  pl-8 space-y-2">
          <li>
            ...
            necessary for contract fulfillment, legal requirements, or pursuing
        ...
        <ul className="font-normal font-poppins list-disc  pl-8 space-y-2">
          <li>
            Personal data is not shared with third parties, except as necessary
            for providing our products and services or as legally permitted or
            required.
          </li>
        </ul>
        <h3 className="text-2xl my-2 pt-2 font-medium font-poppins">
        ...
        <ul className="font-normal font-poppins list-disc  pl-8 space-y-2">
          <li>
            Services may include social sharing features that allow you to share
            information with friends or the public.
          </li>
        </ul>
        <h3 className="text-2xl my-2 pt-2 font-medium font-poppins">
          6. Security
        ...
        <ul className="font-normal font-poppins list-disc  pl-8 space-y-2">
          <li>
            Your data may be transferred to and processed on our servers outside
            your country.
          </li>
          <li>
        ...
        <ul className="font-normal font-poppins list-disc  pl-8 space-y-2">
          <li>
            ...
            your rights, contact us at: Saguni Tech LLC, Business Center 1, Nad
            Al Sheba, Dubai, U.A.E, Email: contact@devomon.io, Contact Person:
            Martin Schulze, Game Director.
          </li>
        </ul>
        <h3 className="text-2xl my-2 pt-2 font-medium font-poppins">

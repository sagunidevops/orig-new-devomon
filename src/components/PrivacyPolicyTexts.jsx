    ...
    <>
      <section className="px-3 relative pb-10 sm:pb-20 lg:pb-24 pt-24 sm:pt-32 bg-black overflow-x-hidden">
        <div className="mx-auto xl:w-[952px] text-white">
          <h3 className="text-white text-4xl  font-bold pb-5">
            <strong>Privacy Policy</strong>{" "}
          </h3>
          <p className="font-normal">Last updated: August 19, 2022</p>
          ...
          <p className="font-normal">
            ...
            <a
              className=" font-normal color-white text-decoration-none"
          ...
          <h3 className="text-2xl my-2 font-medium">
            <strong>Interpretation and Definitions</strong>
          </h3>
          <h3 className="text-2xl my-2 font-medium">Interpretation</h3>
          <p className="font-normal">
            {" "}
          ...
          <h3 className="text-2xl my-2 font-medium">Definitions</h3>
          <p className="font-normal mb-2">
            For the purposes of this Privacy Policy:
          </p>
          <ul className="font-normal list-disc  pl-8 space-y-2">
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Devomon, Dubai.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Devomon, accessible from
                <a
          ...
          <h4 className="text-2xl my-2 font-medium">Types of Data Collected</h4>
          <h3 className="text-2xl my-2 font-medium">Personal Data</h3>
          ...
          <ul className="font-normal list-disc  pl-8 space-y-2 py-6">
            <li>
              <p>Email address</p>
            </li>
            <li>
          ...
          <h3 className="text-2xl my-2 font-medium">Usage Data</h3>
          <p className="font-normal mb-2">
          ...
          <h3 className="text-2xl my-2 font-medium">Business Transactions</h3>
          <p className="font-normal">
          ...
          <h2 className="text-2xl my-2 font-medium">Children's Privacy</h2>
          <p className="font-normal">
          ...
          <h2 className="text-2xl my-2 font-medium">Contact Us</h2>
          <p className="font-normal">

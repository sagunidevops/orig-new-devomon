          ...
          <div className="grid lg:grid-cols-5 gap-16 items-start">
            ...
            <div className="lg:col-span-2 flex justify-center lg:justify-end">
              <div className="relative group">
                ...
                <Image src="/images/voidborn-right.jpg" alt="Voidborn Webtoon Panel" width={300} height={200} className="relative z-10 object-contain drop-shadow-2xl group-hover:scale-[1.02] transition-all duration-500 ease-out rounded-2xl" />
              </div>
            </div>
          </div>
        </div>

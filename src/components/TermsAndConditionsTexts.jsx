      ...
      <section className="px-3 relative pb-10 sm:pb-20 lg:pb-24 pt-24 sm:pt-32 bg-black overflow-x-hidden">
        <div className="mx-auto xl:w-[952px]">
          <h3 className="text-white sm:text-4xl text-[28px] font-poppins font-bold pb-3">
            Service Terms for Devomon by Saguni Tech LLC - FZ - "Devomon
            Callisto"
          </h3>
          ...
          <ul className="text-white list-decimal list-outside sm:ps-7 ps-4 font-poppins">
            <li className="sm:ps-3 pt-3">
              <p>
                <strong className="text-[18px]">INTRODUCTION:</strong> These
                Terms of Service ("Terms") govern your access to and use of our
                services, including our games, mobile applications, websites,
                and other online products and services (collectively referred to
                as "Services"), provided by SaGuNi Tech L.L.C - FZ ("we," "us,"
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                notify you of such changes by changing the date of the last
                update at the top of this page and, in some cases, providing
                additional notice. Your continued use of the Services following
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                <p>
                  ...
                  Services may utilize the integration of Beam from Merit
                  Circle, which allows you to use game accounts for optional
                  Web3 features. This use is voluntary and supplements the basic
                  Web2 elements of the game.
                </p>{" "}
                <p>
                  ...
                  security of their account and must keep passwords
                  confidential. Any activities occurring under their account are
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                content and services of Devomon are copyrighted. Users are
                granted a license to use, without obtaining any ownership rights
              </p>
            </li>
            <li className="sm:ps-3 pt-3">
              <p>
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                These Terms are governed by the laws of your country and should
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                <p>
                  ...
                  You may not use the Services for illegal purposes or in a
                  manner that could harm, disable, overload, or impair our
                  Services.
                </p>
                <p>
                  <span className="font-poppins font-medium">
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                <p>
                  ...
                  you grant us a limited license to use that content in
                ...
                <p>
                  ...
                  consequences. Users are responsible for the content they
                  create. We reserve the right to remove content that violates
                  our guidelines
                </p>
              </p>
            </li>
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                <p>
                  ...
                  deleting your account or discontinuing the use of the
                  Services.
                </p>{" "}
                <p>
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                must adhere to our code of conduct, including avoiding
                harassment, fraud, and other inappropriate behaviors.
              </p>
            </li>
            <li className="sm:ps-3 pt-3">
              <p>
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                employees, and agents from all claims, damages, losses, and
                costs arising from your use of the Services or your violation of
                these Terms.
              </p>
            </li>
            <li className="sm:ps-3 pt-3">
            ...
            <li className="sm:ps-3 pt-3">
              <p>
                ...
                <p>
                  <span className="font-medium">a) Entire Agreement:</span>{" "}
                  These Terms constitute the entire agreement between you and
                  SaGuNi Tech L.L.C - FZ and supersede all previous agreements
                  and understandings.
                </p>
          ...
          <p className="text-white pt-5 font-poppins">
            ...
            contact@devomon.io Company Address: Saguni Tech LLC Business Center
            1, Nad AI Sheba, Dubai, U.A.E Contact Person: Martin Schulze, Game
            Director
          </p>
        </div>
      </section>

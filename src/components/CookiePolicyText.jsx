      ...
      <div className="mx-auto xl:w-[952px] ">
        ...
        <div className="mb-8">
          ...
          <p className="text-white font-normal mb-4">
            ...
            Devomon Game Website, why we use them, and how you can control them.
          ...
          <p className="text-white font-normal ">
            ...
            visit a website. They are widely used in order to make websites
        ...
        <div className="mb-8">
          ...
          <ul className="text-white font-normal ">
            <li className="mb-2">
              ...
              functioning of the website and cannot be disabled. They allow you
              to navigate the website and use its features, such as accessing
            ...
            <li className="mb-2">
              Functionality cookies: These cookies store information that allows
              us to remember your preferences and settings, such as your
              language preference. Advertising cookies: These cookies are used
              ...
              advertisement and to help measure the effectiveness of an
        ...
        <div className="mb-8">
          ...
          <ul className="text-white font-normal">
            <li className="mb-2">
              You can control and manage cookies in several ways. You can adjust
              your web browser settings to reject some or all cookies, or to
              alert you when a website is attempting to place a cookie on your
              device. However, please be aware that disabling cookies may limit
        ...
        <div className="mb-8">
          ...
          <ul className="text-white font-normal">
            <li className="mb-2">
              ...
              please contact us at <Link href={"http://"}></Link>
              <Link
                to={"mailto:contact@devomon.io"}
                target="_blank"
